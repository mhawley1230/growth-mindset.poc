...
#@onready var plants_ui = get_tree().root.get_node("SceneTree/UIContainer/PlantsUI/MarginContainer/GridContainer")
#@onready var seeds_ui = get_tree().root.get_node("SceneTree/UIContainer/SeedsUI/MarginContainer/GridContainer")
#
