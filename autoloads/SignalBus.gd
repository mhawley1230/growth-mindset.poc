...
signal on_plant_inventory_updated(plant_name: String, num: int)
signal on_seed_inventory_updated(seed_name: String, num: int)
...
func emit_on_inventory_manager_ready(inventory_manager: InventoryManager) -> void:
	on_inventory_manager_ready.emit(inventory_manager)
...
func emit_on_plant_inventory_updated(plant_name: String, num: int) -> void:
	on_plant_inventory_updated.emit(plant_name, num)


func emit_on_seed_inventory_updated(seed_name: String, num: int) -> void:
	on_seed_inventory_updated.emit(seed_name, num)
